...
' ���Ŕԍ�����ї���:
'   2.20.0 (2026-06-13) [�N��] startup_full ���s���̓��{�����X�L�b�v�iRunPython �����h�~�j�B
'   2.19.0 (2026-06-13) [�N��] EnsurePythonHostsReady �� hwnd �n���EWaitForm �� RunPython �O�ֈړ��B
'   2.18.0 (2026-06-13) [�N��] ���{������O�� EnsurePythonHostsReady�iPython �����m�F�j�B
'   2.17.0 (2026-06-13) [�I��] B+A: BeforeClose �� ShutdownExcelUiVbaOnly �̂݁iPython �� lifecycle monitor�j�B
'   2.15.0 (2026-06-07) [�I��] ShutdownExcelUiCleanup: excel_shutdown_workbook_close 1 �񉻁irestore/shutdown/registry �� 1 RunPython�j�B
'   2.14.0 (2026-06-06) [UX] WaitForm: bridge �� WaitForUiReadySignal�iready �t�@�C���҂��EVBA �� NotifyUiReady�j�B
'   2.13.0 (2026-06-06) [UX] ForceCursorOnProgress: �i���_�C�A���O�\�����̍����v ON�B�ی��^�C�}�Ȃ��B�O�� Python ���� Application.Run �ŌĂԁiProgressDialog show/teardown �̂ݐ���j�B
'   2.12.0 (2026-06-03) [�I��] ShutdownExcelUiCleanup: shutdown_all_with_force_kill('excel_shutdown') ��ǉ��B
'   2.11.0 (2026-06-01) [UX] ForceCursorOn: �{�ԃf�[�^�W��ꊇ�̍����v ON�B�O�� Python ���� Application.Run �ŌĂԁiCOM �� Cursor �������͕s�̂��߁j�B
...
' ---------------------------------------------------------------------------------------------------------------------
' ---------------------------------------------------------------------------------------------------------------------
' �v���V�[�W����: ShutdownExcelUiVbaOnly
' ���Ŕԍ�����ї���: 1.0.0 (2026-06-13) BeforeClose �p VBA �̂ݕЕt���iPython �I���� lifecycle monitor �ɈϏ��j�B
' �v���V�[�W���̓���T�v: WaitForm / OnTime / Cursor / Interactive �𕜌�����BRunPython �͌Ă΂Ȃ��B
' �ďo����: Call Main.ShutdownExcelUiVbaOnly
' ---------------------------------------------------------------------------------------------------------------------
...
' ---------------------------------------------------------------------------------------------------------------------
' �v���V�[�W����: EnsurePythonHostsReady
' ���Ŕԍ�����ї���: 1.1.0 (2026-06-13) hwnd ��n���� register_book�B�}���` Excel ���񃊃{���΍�B
' �v���V�[�W���̓���T�v: ensure_python_hosts_ready(hwnd) �� 1 �� RunPython �ŌĂԁB
' ---------------------------------------------------------------------------------------------------------------------
...
Private Sub RibbonInvokeFromControl(ByVal control As Object)
    ...
    ' # �y�ړI�zWorkbook_Open �� startup_full RunPython ���s���� 2 �{�ڂ� RunPython �������i�}���` Excel ���񃊃{�������j�B
    If mWorkbookOpenStartupFullStarted And Not mWorkbookOpenFullPythonDone Then
        Call HC_Log.Info("Main", "RibbonInvoke: startup_full ���s���̂��߃X�L�b�v�i������ɍđ��삵�Ă��������j")
        Call HC_RibbonPerf.RibbonPerfEnd
        Exit Sub
    End If
...
' �v���V�[�W����: ForceCursorOn
' ���Ŕԍ�����ї���:
'   1.0.0 (2026-06-01) �{�Ԉꊇ compute ��: xlWait ON + CursorGuard �^�C�}�ĕ����B
' �v���V�[�W���̓���T�v: RunPythonSafe ��o�R�̒����ԏ����� Excel �����v��\������B
' �ďo����: Application.Run "Main.ForceCursorOn", sheetId
' �w���p�[�v���V�[�W���̐e�q�֌W: (�q) StartCursorGuardTimer
' ---------------------------------------------------------------------------------------------------------------------
...
' ---------------------------------------------------------------------------------------------------------------------
' �v���V�[�W����: ForceCursorOnProgress
' ���Ŕԍ�����ї���:
'   1.0.0 (2026-06-06) �i���_�C�A���O�\���J�n: xlWait ON�iStartCursorGuardTimer �͌Ă΂Ȃ��j�B
' �v���V�[�W���̓���T�v: ProgressDialog �� showEvent ����̂ݍ����v�� ON �ɂ���B
' �ďo����: Application.Run "Main.ForceCursorOnProgress", sheetId
' �w���p�[�v���V�[�W���̐e�q�֌W: (�Ȃ�) ForceCursorOff �� Python �� notify_ui_ready �ŉ���
' ---------------------------------------------------------------------------------------------------------------------
...
' ���Ŕԍ�����ї���:
'   1.2.0 (2026-06-07) excel_shutdown_workbook_close 1 �񉻁irestore/shutdown/registry clear�j�B
...
' �v���V�[�W���̓���T�v: �A�h�C���I�����O�� VBA �� UI �𕜌����APython �I���� 1 ��� RunPython �Ŏ��s�B
